...
@section('frontend-section')
                ...
                <div class="card border-left-success shadow h-100 py-2">
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                <div class="text-xs font-weight-bold text-success text-uppercase mb-1">consumption price
                                </div>
                                <div class="h5 mb-0 font-weight-bold text-gray-800">
                                    <h3>${{ $orderItemsTotalPrice }}</h3>
                                </div>
                            </div>
                            <div class="col-auto">
            ...
            <div class="col-xl-3 col-md-6 mb-4">
                <div class="card border-left-primary shadow h-100 py-2">
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Number of orders
                                </div>
                                <div class="h5 mb-0 font-weight-bold text-gray-800">
                                    <h3>{{ $orderCount }}</h3>
                                </div>
            ...
            <div class="col-xl-3 col-md-6 mb-4">
                <div class="card border-left-info shadow h-100 py-2">
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                <div class="text-xs font-weight-bold text-info text-uppercase mb-1">Number of Wishlists
                                </div>
                                <div class="h5 mb-0 font-weight-bold text-gray-800">
                                    <h3>{{ $wishlistCount }}</h3>
                                </div>
            ...
            <div class="card border-left-warning shadow h-100 py-2">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        ...
                        <div class="col-auto">
                            <i class="fas fa-umbrella-beach fa-2x text-warning"></i>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-xl-8 col-lg-7">
                ...
                <div class="card shadow mb-4">
                    <div class="card-header py-3">
                        <h6 class="m-0 font-weight-bold text-primary">Your Consumption Price</h6>
                    </div>
                    <div class="card-body">
                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mt-4 text-center small">
                            <span class="mr-2">
                                <i class="fas fa-circle text-primary"></i> Wishlists
                            </span>
                            <span class="mr-2">
                                <i class="fas fa-circle text-success"></i> Consumption Price
                            </span>
                            <span class="mr-2">
                                <i class="fas fa-circle text-info"></i> Order
                            </span>
                        </div>
                        {{-- <hr>
    ...
    {{-- Total Price Area Chart --}}
    <script type="text/javascript">
        // Assuming you have a variable named _monthlyTotalData containing the monthly total data
        var _monthlyTotalData = {!! json_encode($monthlyTotalDataForUser) !!};

        console.log('_monthlyTotalData', _monthlyTotalData);

    </script>

    {{-- All Item Pie Chart --}}
    <script type="text/javascript">
        var _type = {!! json_encode($labels) !!};
        var _item = {!! json_encode($data) !!};
        console.log(_labels);
        console.log(_data);
    </script>
