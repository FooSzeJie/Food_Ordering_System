			...
			<div class="logo_invoice_wrap">
				...
				<div class="invoice_sec">
					...
					<p class="invoice_no">
						...
						<span>: {{ $userorder->tracking_no }}</span>
					</p>
					<p class="date">
						<span class="bold">Date :</span>
						<span>{{ $userorder->created_at->format('d-m-Y') }}</span>
					</p>
                    <p class="date">
                        <span class="bold">Time :</span>
                        <span>{{ $userorder->created_at->format('h:i:s A') }}</span>
                    </p>
                    <p class="date">
                ...
                <div class="bill_total_wrap">
                    ...
                    <div class="bill_sec">
                        <p>Bill To</p>
                        <p class="bold name">Name: {{ $userorder->user_name }}</p>
                    </div>
