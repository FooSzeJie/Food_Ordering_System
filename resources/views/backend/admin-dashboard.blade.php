...
@section('backend-section')
            ...
            <div class="col-xl-3 col-md-6 mb-4">
                <div class="card border-left-primary shadow h-100 py-2">
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Monthly User Order
                                </div>
                                <div class="h5 mb-0 font-weight-bold text-gray-800">
                                    <h2>{{ $ordersCount }}</h2>
                                </div>
                    ...
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                ...
                                <div class="h5 mb-0 font-weight-bold text-gray-800"><h2>{{ App\Models\User::count() }}</h2></div>
                            </div>
                            <div class="col-auto">
                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mt-4 text-center small">
                            <span class="mr-2">
                                <i class="fas fa-circle text-primary"></i> Variant
                            </span>
                            <span class="mr-2">
                                <i class="fas fa-circle text-success"></i> Add On
                            </span>
                            <span class="mr-2">
                                <i class="fas fa-circle text-info"></i> Product
                            </span>
                        </div>
                        {{-- <hr>
    ...
    <script src="{{ asset('admindashboard/js/demo/chart-bar-demo.js') }}"></script>
@endsection
